" Sourced from JessFraz vimrc with some customizations
...
"  Use relative numbers to where the cursor is.
set relativenumber
...
au BufNewFile,BufRead *.yml,*.yaml setlocal expandtab ts=2 sw=2 nofoldenable
